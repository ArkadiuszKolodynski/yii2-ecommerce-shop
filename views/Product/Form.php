...
<div class="panel">
    <div class="panel-body">
        ...
        <?php $f = ActiveForm::begin([
            'action' => Url::toRoute('/product/form'),
        ...
        echo $f->field($product, 'brand_id')
          ->dropdownList($brandIds, ['style' => 'width: 200px']);
        ...
        echo $f->field($product, 'detail')->widget(CKEditor::className(), [
          'options' => ['rows' => 6],
          'preset' => 'basic'
        ]);
